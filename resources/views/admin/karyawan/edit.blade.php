...
<br><br><br><br>
  ...
  <div class="panel panel-default">
    <div class="panel panel-body">
      <form method="post" action="/admin/karyawan/{{ $data->id }}/edit" autocomplete enctype="multipart/form-data">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="form-group">
          <div class="row">
            <div class="col-md-3">
              <label for="idKar" class="label-control">ID Karyawan</label>
              <input type="text" name="idKar" value="{{ $data->idKaryawan }}" class="form-control" readonly>
            </div>
          </div>
        </div>
        ...
        <div class="form-group {{ $errors->has('nmKar') ? 'has-error' : '' }}">
          <div class="row">
            <div class="col-md-12">
              ...
              <input type="text" name="nmKar" value="{{ $data->nmKaryawan }}" class="form-control">  
        ...
        <div class="form-group {{ $errors->has('noTelpKar') ? 'has-error' : '' }}">
          ...
          <input type="text" name="noTelpKar" value="{{ $data->noTelpKar }}" class="form-control" maxlength="12">
        ...
        <div class="form-group {{ $errors->has('alamatKar') ? 'has-error' : '' }}">
          ...
          <input type="text" name="alamatKar" value="{{ $data->alamatKar }}" class="form-control">
        ...
        <div class="form-group {{ $errors->has('fotoKaryawan') ? 'has-error' : '' }}">
              ...
              <img src="{{ asset('/storage/fotoKaryawan/'.$data->fotoKaryawan ) }}" width="250" height="200" alt="Foto Tidak Ada" id="foto"><br><br>
        ...
        <input type="hidden" value="{{ $data->nmKaryawan }}" name="nmKarLama">
        <input type="hidden" value="{{ $data->alamatKar }}" name="alamatKarLama">
      </form>
    </div>
  </div>
