    ...
    <div class="panel panel-body">
      <form method="post" autocomplete  enctype="multipart/form-data">
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-md-3">
              ...
              <input type="text" name="kdAlat" value="{{ $kode }}" class="form-control" readonly>
            </div>
          </div>
        </div>
        ...
        <div class="form-group {{ $errors->has('nmAlat') ? 'has-error' : '' }}">
          <div class="row">
            <div class="col-md-12">
              ...
              <input type="text" name="nmAlat" value="{{ old('nmAlat') }}" class="form-control">  
        ...
        <div class="form-group {{ $errors->has('merkAlat') ? 'has-error' : '' }}">
          ...
          <input type="text" name="merkAlat" value="{{ old('merkAlat') }}" class="form-control">
          {!! $errors->first('merkAlat','<p class=help-block>:message</p>') !!}
        </div>

        <div class="form-group {{ $errors->has('ketAlat') ? 'has-error' : '' }}">
          <label for="ketAlat" class="label-control">Keterangan Peralatan</label>
          <textarea name="ketAlat" class="form-control" rows="6">{{ old('ketAlat') }}</textarea>
