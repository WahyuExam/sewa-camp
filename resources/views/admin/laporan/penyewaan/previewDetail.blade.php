...
@section('content')
    ...
    <center><h4>Laporan Penyewaan Alat Perdetail</h4></center>

    Kode Sewa : {{ $listDetail[0]->kdPinjam }} / {{ date('d - m - Y', strtotime($listDetail[0]->tglPinjam)) }} <br>
    Nama Pelanaggan / Penyewa : {{ $listDetail[0]->nmPelanggan }}<br>
    Detail Peralatan Disewa :
