        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <form method="POST" class="side-by-side">
                    ...
                    <div class="row">
                        <div class="col-md-12 {{ $errors->has('biayaSewa') ? 'has-error' : '' }}">
                            <label class="label-control">Biaya Sewa (Rp)</label>
                            <input type="text" name="biayaSewa" class="form-control" value="{{ $dataAlats->biayaSewa }}">
                            {!! $errors->first('biayaSewa','<p class=help-block>:message</p>') !!}
                        </div>

                        <div class="col-md-12">
                            <label class="label-control">Stok Alat Sekarang</label>
                            <input type="text" name="stokAlatLama" class="form-control" value="{{ $dataAlats->stok }}" readonly>
                        </div>

                        <div class="col-md-12 {{ $errors->has('stokAlat') ? 'has-error' : '' }}">
                            <label class="label-control">Update Stok Alat</label>
                            <input type="text" name="stokAlat" class="form-control" value="{{ old('stokAlat') ? old('stokAlat') :'0'  }}">
